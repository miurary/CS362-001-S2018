					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   //if (methodName.equals("setTitle")){
						...
						if (methodName.equals("setValid")) {
							...
							int choose = ValuesGenerator.getRandomIntBetween(random, 1, 4);
							switch(choose) {
								case 1: appt.isOn(startDay, startMonth, startYear);
												break;
								case 2: appt.isOn(startDay - 1, startMonth, startYear);
												break;
								case 3: appt.isOn(startDay, startMonth - 1, startYear);
												break;
								case 4: appt.isOn(startDay, startMonth, startYear - 1);
												break;
							}
						}
						else if (methodName.equals("setRecurrence")){
							int sizeArray=ValuesGenerator.getRandomIntBetween(random, 0, 8);
							int choose = ValuesGenerator.getRandomIntBetween(random, 1, 2);
							int[] recurDays;
							if (choose == 1)
